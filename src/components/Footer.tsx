...
export default function Footer() {
  return (
    <footer className="bg-navy pt-16 pb-24 lg:pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-5 leading-relaxed">
              Professional cleaning services you can trust. Serving the greater
              metropolitan area with excellence since 2019.
            </p>
            <div className="flex gap-3">
              <a
                href="#"
                className="w-9 h-9 bg-white/10 hover:bg-blue rounded-lg flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2.5">
                <svg
                  className="w-4 h-4 text-blue shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} ProClean Services. All rights reserved.
          </p>
